...
module.exports = async function (callback) {
    ...
    await _TOKENPLAY.addNFT(10007,priceNFT,accounts[3],5,15,0, {from: accounts[0]});

    await _TOKENPLAY.purchaseNFT(10007, {from: accounts[4], value: 2000000000000000000 });

    console.log(await _TOKENPLAY.totalSupply(10007));
